...
function CreateSelfSignedCertificate([string]$DnsName)
{
    ...
    # build the filepath - in this case 
    # C:\_localDev\Microservice-ASF-In-Production-Ivan-Sep2018\xxxx.pfx
...
# upload certificate to key vault to be used by the cluster
